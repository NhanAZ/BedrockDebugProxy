...
The feature branch diverged before the final `v1.61.0` fixes. Its reviewed protocol changes were merged onto the stable base instead of replacing the tree. This preserves the stable optional `FilteredCustomName` item-stack encoding while updating the selected protocol to Bedrock 1.26.50, protocol 2193.
